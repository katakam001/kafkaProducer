...
import com.example.demo.kafkaConsumers.SimpleKafkaConsumer;
...
class SimpleKafkaProducerApplication implements CommandLineRunner {
	...
	private static final Logger logger = LogManager.getLogger(SimpleKafkaProducerApplication.class);
